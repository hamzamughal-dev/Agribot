  ...
  return (
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="backdrop-blur-xl bg-white/20 border border-white/30 rounded-2xl shadow-xl overflow-hidden">
        <div className="px-6 py-4 bg-gradient-to-r from-white/10 to-emerald-50/20 border-b border-white/20 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 backdrop-blur-md bg-white/40 hover:bg-white/50 border border-white/30 rounded-xl text-emerald-700 font-medium transition-all duration-300 flex items-center space-x-2 text-sm"
